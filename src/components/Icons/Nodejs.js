...
function SvgNodejs(props) {
  return (
    ...
    >
      <defs>
        <linearGradient x1="68.188%" y1="17.487%" x2="27.823%" y2="89.755%" id="nodejs_svg__b">
        ...
        <linearGradient x1="43.277%" y1="55.169%" x2="159.245%" y2="-18.306%" id="nodejs_svg__d">
        ...
        <linearGradient x1="-4413.77%" y1="13.43%" x2="5327.93%" y2="13.43%" id="nodejs_svg__e">
        ...
        <linearGradient x1="-4.389%" y1="49.997%" x2="101.499%" y2="49.997%" id="nodejs_svg__f">
          <stop stopColor="#6CC04A" offset="9.192%" />
          <stop stopColor="#66B848" offset="28.64%" />
          <stop stopColor="#54A044" offset="59.68%" />
          <stop stopColor="#41873F" offset="86.24%" />
        </linearGradient>
        <linearGradient x1="-9713.77%" y1="36.21%" x2="27.93%" y2="36.21%" id="nodejs_svg__g">
          <stop stopColor="#6CC04A" offset="9.192%" />
          <stop stopColor="#66B848" offset="28.64%" />
          <stop stopColor="#54A044" offset="59.68%" />
          <stop stopColor="#41873F" offset="86.24%" />
        </linearGradient>
        <linearGradient x1="-103.861%" y1="50.275%" x2="100.797%" y2="50.275%" id="nodejs_svg__h">
          <stop stopColor="#6CC04A" offset="9.192%" />
          <stop stopColor="#66B848" offset="28.64%" />
          <stop stopColor="#54A044" offset="59.68%" />
          <stop stopColor="#41873F" offset="86.24%" />
        </linearGradient>
        <linearGradient x1="130.613%" y1="-211.069%" x2="4.393%" y2="201.605%" id="nodejs_svg__i">
          <stop stopColor="#41873F" offset="0%" />
          <stop stopColor="#418B3D" offset="32.88%" />
          <stop stopColor="#419637" offset="63.52%" />
          <stop stopColor="#3FA92D" offset="93.19%" />
      ...
      <g fill="none">
        ...
        <g transform="translate(134.068 70.501)">
          <mask id="nodejs_svg__c" fill="currentColor">
